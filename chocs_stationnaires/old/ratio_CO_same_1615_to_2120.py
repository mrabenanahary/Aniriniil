...
ax.set_ylabel(r'$\ce{{}^12CO}$~$16-15$/$21-20$',fontsize=23,fontweight='extra bold')
...
chemina='./Table2_yang17_CO.txt'
cheminb='./Table2_yang17_CO.txt'
indexLine1=-13 #CO1615
indexLine2=-18 #p-H2O	404.00	313.00	319.50	171.0    125.38 <=> FREQ = 2391.57290 GHz
...
plt.savefig("ratio_CO_same_1615_to_2120.png", bbox_inches='tight')
plt.savefig("ratio_CO_same_1615_to_2120.pdf", bbox_inches='tight')
plt.show()    
plt.close()
