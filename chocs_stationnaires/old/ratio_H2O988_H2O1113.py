...
"""Dénominateur"""
raieNomDen = '\ce{H2O} 1113 GHz'
nameFilesDen = 'pH2O_int_int_b.out'
...
lgd = plt.legend(fontsize=7,loc='lower right',ncol=1,bbox_to_anchor=(1.1,-0.05))
