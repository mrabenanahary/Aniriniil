...
labels={'c-n5-b1/v5' : r'$V_s=5 km.s^{-1}$ (choc C)',
        'c-n5-b1/v10': r'$V_s=10 km.s^{-1}$ (choc C)',
        'c-n5-b1/v19': r'$V_s=19 km.s^{-1}$ (choc C)',
        'c-n5-b1/v20': r'$V_s=20 km.s^{-1}$ (choc J)',
        'c-n5-b1/v25': r'$V_s=25 km.s^{-1}$ (choc J)',
        'c-n5-b1/v30': r'$V_s=30 km.s^{-1}$ (choc J)'
           }
...
for ii,densiteChamp in enumerate(dirlist):
    ...
    ulist = ['c-n5-b1/v5', 'c-n5-b1/v10','c-n5-b1/v19', 'c-n5-b1/v20', 'c-n5-b1/v25', 'c-n5-b1/v30']
...
lgd.set_title(r'\underline{$n_H=10^5~cm^{-3}$ $b=1$ :}',prop={'size':12})
"""
...
plt.savefig("H2_Excit_Diag_c-n5.png", bbox_inches='tight')
plt.savefig("H2_Excit_Diag_c-n5.pdf", bbox_inches='tight')
plt.show()    
plt.close()