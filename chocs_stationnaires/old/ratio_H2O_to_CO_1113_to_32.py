...
ax.set_ylabel(r'rapport de $\sum T\mathrm{d}v$ 1113GHz p-$H_2O$/CO(3-2)',fontsize=23,fontweight='extra bold')
...
for kk,vitesse in enumerate(ulist):
    ...
    #print(Y)
    Y.append((fig4data[0])[1]/(fig4datab[2])[1])
...
plt.savefig("ratio_H2O_to_CO_1113_to_32.png", bbox_inches='tight')
plt.savefig("ratio_H2O_to_CO_1113_to_32.pdf", bbox_inches='tight')
plt.show()    
plt.close()
