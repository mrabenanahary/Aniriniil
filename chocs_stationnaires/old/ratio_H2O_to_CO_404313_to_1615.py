...
ax.set_ylabel(r'$\ce{H2O}$~$4_{04}-3_{13}$/$\ce{{}^12CO}$~$16-15$',fontsize=23,fontweight='extra bold')
...
""" Input Python"""
labelMolecule = r'$\ce{H2O}$~$4_{04}-3_{13}$/$\ce{{}^12CO}$~$16-15$'
...
indexLine1=0 #CO1615
indexLine2=-13 #p-H2O	404.00	313.00	319.50	171.0    125.38 <=> FREQ = 2391.57290 GHz
