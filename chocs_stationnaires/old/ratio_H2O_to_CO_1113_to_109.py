...
ax.set_ylabel(r'rapport de $\sum T\mathrm{d}v$ 1113GHz p-$H_2O$/CO(10-9)',fontsize=23,fontweight='extra bold')
...
for kk,vitesse in enumerate(ulist):
    ...
    #print(Y)
    Y.append((fig4data[0])[1]/(fig4datab[9])[1])
...
ax.plot(ratio1X,ratio1Y,label=r' HIFI 1113 GHz/APEX CO(10-9)')        
...
plt.savefig("ratio_H2O_to_CO_1113_to_109.png", bbox_inches='tight')
plt.savefig("ratio_H2O_to_CO_1113_to_109.pdf", bbox_inches='tight')
plt.show()    
plt.close()
