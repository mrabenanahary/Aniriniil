...
indexRaieNumerateurModele1=13
indexRaieNumerateurModele2=1
indexRaieDenominateurModele1=15
indexRaieDenominateurModele2=1
fileNumerateur = "pH2O_int_int_b.out"
...
indexLine1=0 #o-H2O	212	     101	     114.40	179.53	516.00 <=> FREQ = 1669.90496 GHz
indexLine2=-12 #p-H2O	404.00	313.00	319.50	171.0    125.38 <=> FREQ = 2391.57290 GHz
...
plt.savefig("ratio_H2O_to_CO_404313_to_1615.png", bbox_inches='tight')
plt.savefig("ratio_H2O_to_CO_404313_to_1615.pdf", bbox_inches='tight')
plt.show()    
plt.close()
