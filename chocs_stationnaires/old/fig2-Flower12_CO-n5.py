...
#plt.text(1, 5e-3,r'$n_H=10^5$ $cm^{-3}$, $B=100$ $\mu G$',fontsize=18,weight='bold')    
"""    
...
plt.savefig("CO_TdV_c-n5.png", bbox_inches='tight')
plt.savefig("CO_TdV_c-n5.pdf", bbox_inches='tight')
plt.show()    
plt.close()
