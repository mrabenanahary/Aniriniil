...
ax.set_ylabel(r'$\ce{H2O}~2_{12}-1_{01}$/$4_{04}-3_{13}$',fontsize=23,fontweight='extra bold')
...
for kk,vitesse in enumerate(ulist):
    ...
    fig4datab = ascii.read(cheminb,header_start=0,data_start=1)
    #Header = (ascii.read(chemin,header_start=0,data_start=1))
    print(fig4data)        
...
indexLine1=10 #o-H2O	212	     101	     114.40	179.53	516.00 <=> FREQ = 1669.90496 GHz
indexLine2=0 #p-H2O	404.00	313.00	319.50	171.0    125.38 <=> FREQ = 2391.57290 GHz
...
plt.savefig("ratio_H2O_same_212101_to_404313.png", bbox_inches='tight')
plt.savefig("ratio_H2O_same_212101_to_404313.pdf", bbox_inches='tight')
plt.show()    
plt.close()
