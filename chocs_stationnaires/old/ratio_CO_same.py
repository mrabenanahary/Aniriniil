...
ratio1X = np.arange(xmin,xmax,(xmax-xmin)/2.)
ratio2X = np.arange(xmin,xmax,(xmax-xmin)/2.)
ratio1Y = np.array([(fig4data[0])[1],(fig4data[0])[1]])
ratio2Y = np.array([(fig4data[1])[1],(fig4data[1])[1]])
...
plt.savefig("ratio_CO_same.png", bbox_inches='tight')
plt.savefig("ratio_CO_same.pdf", bbox_inches='tight')
plt.show()    
plt.close()
