...
"""Numérateur"""
Eup1=2399.82
raieNomNum = 'CO(29-28) ('+str(Eup1)+' K)'
...
dirlistNum = []
vitesseTimeNum = []
lambdaNumMicrons=90.16 #a remplir si les données Yang 2017 sont activées



"""Dénominateur"""
Eup2=1656.47
raieNomDen = 'CO(24-23) ('+str(Eup2)+' K)'
...
dirlistDen = []
vitesseTimeDen = []
lambdaDenMicrons=108.75 #a remplir si les données Yang 2017 sont activées
...
FluxNumYang=165. #1e-18 W/m2
FluxDenYang=508. #1e-18 W/m2
errorNumYang = 23.6 #1e-18 W/m2
errorDenYang = 43.9 #1e-18 W/m2
