...
"""\ce{H2O} 1153 GHz"""
Eup1=249.4
raieNomNum = r'\ce{H2O} 1153 GHz ('+str(Eup1)+' K)'
...
dirlistNum = []
vitesseTimeNum = []
lambdaNumMicrons=259.98 #a remplir si les données Yang 2017 sont activées



"""CO(10-9)"""
Eup2=304.16
raieNomDen = 'CO(10-9) ('+str(Eup2)+' K)'
...
lgd = plt.legend(fontsize=14,loc='lower center',ncol=2,bbox_to_anchor=(0.5, -0.5))
