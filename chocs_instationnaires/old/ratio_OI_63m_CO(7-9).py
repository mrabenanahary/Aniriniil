...
dirlistDen = []
vitesseTimeDen = []
lambdaDenMicrons=371.64 #a remplir si les données Yang 2017 sont activées
...
FluxDenYang=349. #1e-18 W/m2
errorNumYang = 74.0 #1e-18 W/m2
errorDenYang = 8.47 #1e-18 W/m2
