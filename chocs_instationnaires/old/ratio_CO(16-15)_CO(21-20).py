...
labeldirFiles = {}
vitDirFiles = [[5,10,19],[10,15,19,20,25,30]]
...
"""Numérateur"""
Eup1=751.72
raieNomNum2 = 'CO(16-15)'
raieNomNum = raieNomNum2+' ('+str(Eup1)+' K)'
...
dirlistNum = []
vitesseTimeNum = []
lambdaNumMicrons=162.82 #a remplir si les données Yang 2017 sont activées



"""Dénominateur"""
Eup2=1276.05
raieNomDen2 = 'CO(21-20)'
raieNomDen = raieNomDen2+' ('+str(Eup2)+' K)'
...
dirlistDen = []
vitesseTimeDen = []
lambdaDenMicrons=124.19 #a remplir si les données Yang 2017 sont
...
if(ActiverYang==True):
    labelRatioYang='PACS'+' '+raieNomNum2+'/'+raieNomDen2
...
fileTitle="ratio_"+"{}".format(raieNomNum2)+"_"+"{}".format(raieNomDen2)
