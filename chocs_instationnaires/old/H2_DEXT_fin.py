...
figRatio, [ax,ax4,ax5] = plt.subplots(1,3, sharey=True,figsize=(10,7))
...
lgd = ax.legend(fontsize=12,loc='best',ncol=1,framealpha=1)
lgd = ax4.legend(fontsize=12,loc='best',ncol=1,framealpha=1)
lgd = ax5.legend(fontsize=12,loc='best',ncol=1,framealpha=1)
