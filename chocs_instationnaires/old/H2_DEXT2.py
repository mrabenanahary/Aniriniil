...
figRatio, [ax,ax2,ax3,ax4] = plt.subplots(1,4, sharey=True,figsize=(21,7))
...
densiteVitesseAge=['cj-n4-b1/v5-t100','cj-n4-b1/v5-t200','cj-n4-b1/v5-t500',
                   'cj-n4-b1/v10-t100','cj-n4-b1/v10-t200','cj-n4-b1/v10-t500',
                   'cj-n4-b1/v19-t100','cj-n4-b1/v19-t200','cj-n4-b1/v19-t500']
...
for i,element in enumerate(densiteVitesseAge):
    ...
    X.append(asciiTemp[13][2])
    Y.append(asciiTemp[13][3])
    ax2.plot(X, Y,'--D', markersize=5, alpha=0.6,markeredgecolor='black',label=element)


densiteVitesseAge=['j-n5-b0.1/v5','j-n5-b0.1/v10','j-n5-b0.1/v15','j-n5-b0.1/v19','j-n5-b0.1/v15','j-n5-b0.1/v20','j-n5-b0.1/v25','j-n5-b0.1/v30']
"""dirFiles = ['cj-n4-b1','cj-n5-b1']
vitDirFiles = [[5,10],[25]]
ageDirFiles = [[[100,250,500],[100,250,500]],[[100,150,250,500]]]    
densiteVitesseAge=[]
...
for i,element in enumerate(densiteVitesseAge):
    ...
    X.append(asciiTemp[13][2])
    Y.append(asciiTemp[13][3])
    ax3.plot(X, Y,'-o', markersize=5, alpha=0.6,markeredgecolor='black',label=element)
...
for i,element in enumerate(densiteVitesseAge):
    ...
    X.append(asciiTemp[13][2])
    Y.append(asciiTemp[13][3])
    ax4.plot(X, Y,'-o', markersize=5, alpha=0.6,markeredgecolor='black',label=element)
...
lgd = ax.legend(fontsize=12,loc='lower center',ncol=2,bbox_to_anchor=(0.5, -0.42))
...
plt.savefig('H2_DEXT_CJ_C_J2.pdf', bbox_inches='tight')
