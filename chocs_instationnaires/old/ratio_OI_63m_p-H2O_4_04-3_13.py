...
"""OI(63$\mu m$)"""
Eup1=227.71
raieNomNum = 'OI(63$\mu m$)'
raieNomNum2 = 'OI(63$\mu m$) ('+str(Eup1)+' K)'
...
"""p-H2O 404-313"""
Eup2=319.5
raieNomDen = 'p-\ce{H2O} $4_{04}-3_{13}$'
raieNomDen2 = 'p-\ce{H2O} $4_{04}-3_{13}$ ('+str(Eup2)+' K)'
...
for i,directory in enumerate(dirFiles):
    ...
    for j,vitesse in enumerate(vitDirFiles[i]):        
        ...
        for k,tempsJ in enumerate((ageDirFiles[i])[j]):
            ...
            print(directory,vitDirName,(figDataNum[directory])[vitesse][tempsJ]/(1.e-12*lambdaNumMicrons**3/(2.*KB)/1.e5))
            """Dénominateur"""
