...
convLocal_function_names = ["NuTOWavelength",
                            "NuTOEnergie",
                            "WavelengthTONu",
                            "WavelengthTOEnergie",
                            "EnergieTONu",
...
for function_names in convLocal_function_names:
    convLocal_function_map[function_names] = extractArgNameList(function_names)
"==================================================="
...
def convertisseurPhysique2(
    ...
    list_of_args = extractArgNameList(name_to_function_map[type_de_conversion])
    for args in list_of_args :
        string_of_args = string_of_args + args + '=' + dic_convLocal_to_convGen[args] + ','
    
    commands = \
"""if("{0:}" in acceptable_inputs):\n out_put = {1:}({2:})\nelse:\n raise("Problème insoluble, aucun des cas de conversions physiques disponibles n'a été appelé !!")""".format(type_de_conversion,name_to_function_map[type_de_conversion],string_of_args)
...
if __name__ == "__main__":
    ...
    l = SurfaceFluxTOSurfaceBrightness(1e7,12,unit_of_surface_flux = u.erg/u.s/u.cm**2,unit_of_theta_s = u.radian,return_quantities=True,unit_of_surface_brightness = u.erg/u.sr/u.cm**2/u.s)
    print("l=",l)
    ...
    n = IntegratedIntensityTOSurfaceBrightness(1e7,12,unit_of_integrated_intensity = u.K*u.m/u.s,unit_of_wavelength = u.millimeter,return_quantities=True,unit_of_surface_brightness = u.erg/u.sr/u.cm**2/u.s)
    print("n=",n)
