...
if __name__ == "__main__":
    ...
    c = SurfaceBrightnessTOIntegratedIntensity(1,2,unit_of_surface_brightness=u.erg/u.sr/u.cm**2/u.s,unit_of_wavelength=u.micrometer,return_quantities=retQtt, unit_of_output = u.K * u.km/u.s)
    print("c=",c)
    
    d = SurfaceBrightnessTOIntegratedIntensity(1,2,unit_of_surface_brightness=u.watt/u.sr/u.m**2,unit_of_wavelength=u.m, return_quantities=retQtt, unit_of_output = u.K * u.km/u.s)
    print("d=",d)
    print((3.62146e-2)*((1e7)/(1e4))*((2e6)**3))
    
    
    e =  SurfaceFluxTOIntegratedIntensity(1e-6,145,10,unit_of_surface_flux = dixMoins18Watt/u.m**2, unit_of_wavelength = u.micrometer, unit_of_theta_s = u.arcsecond, unit_of_output = u.K*u.km/u.s)
    print("e=",e)
    
    f = SurfaceFluxTOIntegratedIntensity(1e-6,145,10,unit_of_surface_flux = u.erg/u.s/u.cm**2,unit_of_wavelength=u.millimeter,unit_of_theta_s=u.radian,return_quantities=True, unit_of_output = u.K*u.km/u.s)
    print("f=",f)
    ...
    h = IntegratedIntensityTOSurfaceFlux(1e7,2,12,unit_of_integrated_intensity = u.K*u.m/u.s,unit_of_theta_s = u.radian,unit_of_wavelength = u.mm,return_quantities=True,unit_of_output = dixMoins18Watt/u.m**2)
    print("h=",h)
    ...
    l = SurfaceFluxTOSurfaceBrightness(1e7,12,unit_of_surface_flux = u.erg/u.s/u.cm**2,unit_of_theta_s = u.radian,return_quantities=True,unit_of_output = u.erg/u.sr/u.cm**2/u.s)
    print("l=",l)
    ...
    n = IntegratedIntensityTOSurfaceBrightness(1e7,12,unit_of_integrated_intensity = u.K*u.m/u.s,unit_of_wavelength = u.millimeter,return_quantities=True,unit_of_output = u.erg/u.sr/u.cm**2/u.s)
    print("n=",n)
